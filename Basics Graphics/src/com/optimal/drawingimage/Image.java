 ...
 */
package com.optimal.drawingimage;
        ...
        imagePanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (displayedImage != null) {
                    ...
                    displayedImage = displayRotatedImage;
                    ...
                    if (monoChrom == true) {
                        ...
                        g.dispose();
                        displayedImage = getplayMonoChoromImage;
                        ...
                        g.dispose();
                        displayedImage = getFilteredBlureImage;
                        ...
                        g.dispose();
                        displayedImage = displayVerticalFlipImage;
                        ...
                        g.dispose();
                        displayedImage = displayHorizenatFlipImage;
                        ...
                        g.dispose();
                        displayedImage = displayHorizenatlFlipImage;
...
//                    displayedImage = DicomUtil.getDicomDCM(imagePath);
        ...
        container.add(selectImgage);
        container.add(increaeRotaionAngel);
        container.add(decreaeRotaionAngel);
        container.add(monochrom);
        container.add(filterBlure);
        container.add(horizentalFlippedDown);
        container.add(horizentalFlippedUp);
        container.add(verticalFlippedRight);
        container.add(verticalFlippedLeft);
        ...
        selectImgage.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    //  displayedImage = DicomUtil.getDicomDCM(imagePath);
                    imagePanel.setMinimumSize(new Dimension(displayedImage.getHeight(), displayedImage.getHeight()));
                    ...
                    imagePanel.setBounds(150, 150, displayedImage.getWidth(), displayedImage.getHeight());

//                    container.add(newTagValueEditText);
...
//                }
    ...
    public static String getImagePath() {
        ...
        chooser.setCurrentDirectory(new java.io.File("/home/shady/"));
