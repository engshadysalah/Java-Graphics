...
import com.optimal.drawing.drawellipse.*;
...
public class CircleDrawer extends JFrame {
    ...
    public void addCericle(int xbegin, int ybegin, int r) {

        circles.add(new Circle(xbegin, ybegin, r));
    ...
    public void paint(Graphics graphics) {
        ...
        if (pointStart == null) {
            ...
            g2d.drawOval(pointStart.x, pointStart.y, (int) pointsEnd.distance(pointsEnd.x, pointStart.y),(int) pointsEnd.distance(pointsEnd.x, pointStart.y));
    ...
    public MouseListener mouseHandler = new MouseAdapter() {
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (e.getPoint().distance(pointStart.x, pointsEnd.y) == 0.0) {
                ...
                addCericle(pointStart.x, pointStart.y,(int) pointsEnd.distance(pointsEnd.x, pointStart.y));
