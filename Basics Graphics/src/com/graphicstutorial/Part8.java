        ...
        private void doDrawing(Graphics g) {
            ...
            for (int line = 0; line < 100; line++) {
                ...
                double ctrlY2 = r.nextDouble() * 1024;
                 ...
                 g2d.draw(new Arc2D.Double(startX, startY, width, height, 0, 180, Arc2D.OPEN));
                 g2d.draw(new Arc2D.Double(startX, startY, width, height, 0, 180, Arc2D.CHORD));
                 g2d.draw(new Arc2D.Double(startX, startY, width, height, 0, 180, Arc2D.PIE));
